# THE CHRGD MULTIVERSE — the gold-standard episode

This is the worked example the engine writes against. It is injected into every
episode's brief the way `brand_bible.md` is injected into the main engine: an
abstract spine tells a model what shape to make, but a good example shows it
what good actually reads like.

**Study the plainness, not the plot.** The most common failure on this show is
writing that sounds clever and cannot be followed. Notice what this episode
does NOT do: no similes, no stacked sentences, no rules you haven't been shown,
no character doing their catchphrase just because they have one.

Two characters. One wants something small. The other is in the way.

---

## The story (this is the prose stage)

> The lat pulldown has had a BACK SOON sign on it since 2019.
>
> On Tuesday morning it worked.
>
...
>
> She had done it at three in the morning, on her own. She had an Allen key in
...
8. **It ends on an image and a question**, not a moral.

---

## Cutting it into slides

Each slide is one beat, in order, ending on the question the next one answers:
...
Note slide 1: it opens on **a person**, mid-action, with something already
wrong — not on the building and not on the sign.
