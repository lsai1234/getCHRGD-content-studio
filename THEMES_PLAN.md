...
| D15 | **Roster locked at 13** — Orangina in (half human, half orange, the wellness girl), Clavicular dropped, Bonnie Blue left out | `MULTIVERSE_ROSTER.md` is final; it becomes `config/roster.toml` in Phase 3. |
